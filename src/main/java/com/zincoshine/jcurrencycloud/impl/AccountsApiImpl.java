...
public class AccountsApiImpl implements AccountsApi {
	 ...
	 * 
	 * @see
	 * com.zincoshine.jcurrencycloud.AccountsApi#createAccount(java.lang.String,
	 * java.lang.String, com.zincoshine.jcurrencycloud.vo.Account)
	 */
	public Account createAccount(String url, String authToken,
		...
		try {
			...
			params.add(new BasicNameValuePair("account_name", theAccount
					.getAccountName()));

			if (theAccount.getLegalEntityType() != null) {
				params.add(new BasicNameValuePair("legal_entity_type",
						theAccount.getLegalEntityType()));
			}
			if (theAccount.getYourRef() != null) {
				params.add(new BasicNameValuePair("your_reference", theAccount
						.getYourRef()));
			}
			if (theAccount.getStatus() != null) {
				params.add(new BasicNameValuePair("status", theAccount
						.getStatus()));
			}
			if (theAccount.getStreet() != null) {
				params.add(new BasicNameValuePair("street", theAccount
						.getStreet()));
			}
			...
			if (theAccount.getStateOrProvince() != null) {
				params.add(new BasicNameValuePair("state_or_province",
						theAccount.getStateOrProvince()));
			}
			if (theAccount.getPostalCode() != null) {
				params.add(new BasicNameValuePair("postal_code", theAccount
						.getPostalCode()));
			}
			if (theAccount.getCountry() != null) {
				params.add(new BasicNameValuePair("country", theAccount
						.getCountry()));
			}
			if (theAccount.getSpreadTable() != null) {
				params.add(new BasicNameValuePair("spread_table", theAccount
						.getSpreadTable()));
			}
			if (theAccount.getIdentificationType() != null) {
				params.add(new BasicNameValuePair("identification_type",
						theAccount.getIdentificationType()));
			}
			if (theAccount.getIdentificationValue() != null) {
				params.add(new BasicNameValuePair("identification_value",
						theAccount.getIdentificationValue()));
			}
	 ...
	 * 
	 * @see
	 * com.zincoshine.jcurrencycloud.AccountsApi#retriveAccount(java.lang.String
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.zincoshine.jcurrencycloud.AccountsApi#findAll(java.lang.String,
	 * java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * com.zincoshine.jcurrencycloud.AccountsApi#updateAccount(java.lang.String,
	 * java.lang.String, java.lang.String,
	 * com.zincoshine.jcurrencycloud.vo.Account)
	 */
	 ...
	 * 
	 * @see
	 * com.zincoshine.jcurrencycloud.AccountsApi#getCurrentAccount(java.lang
